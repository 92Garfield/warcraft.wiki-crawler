...
--- @class C_EditMode
--- C_EditMode namespace contains 11 functions
local C_EditMode = {}

--[=[
-- C_EditMode Functions:
...
---
--- @see https://warcraft.wiki.gg/wiki/API_C_EditMode.ConvertLayoutInfoToString
---
--- Usage: layoutInfoAsString = C_EditMode.ConvertLayoutInfoToString(layoutInfo)
---
...
---
--- @see https://warcraft.wiki.gg/wiki/API_C_EditMode.ConvertStringToLayoutInfo
---
--- Usage: layoutInfo = C_EditMode.ConvertStringToLayoutInfo(layoutInfoAsString)
---
...
---
--- @see https://warcraft.wiki.gg/wiki/API_C_EditMode.GetAccountSettings
---
--- Usage: accountSettings = C_EditMode.GetAccountSettings()
---
...
---
--- @see https://warcraft.wiki.gg/wiki/API_C_EditMode.GetLayouts
---
--- Usage: layoutInfo = C_EditMode.GetLayouts()
---
--- Examples:
--- Example 1:
---   local layout = {
...
---
--- @see https://warcraft.wiki.gg/wiki/API_C_EditMode.IsValidLayoutName
---
--- Usage: isApproved = C_EditMode.IsValidLayoutName(name)
---
...
--- C_EditMode.OnEditModeExit
---======================================================================
--- @see https://warcraft.wiki.gg/wiki/API_C_EditMode.OnEditModeExit
---
--- Usage: C_EditMode.OnEditModeExit()
---
...
--- @see https://warcraft.wiki.gg/wiki/API_C_EditMode.OnLayoutAdded
---
...
---
--- @see https://warcraft.wiki.gg/wiki/API_C_EditMode.OnLayoutDeleted
---
...
---
--- @see https://warcraft.wiki.gg/wiki/API_C_EditMode.SaveLayouts
---
--- Usage: C_EditMode.SaveLayouts(saveInfo)
---
...
---
--- @see https://warcraft.wiki.gg/wiki/API_C_EditMode.SetAccountSetting
---
...
---
--- @see https://warcraft.wiki.gg/wiki/API_C_EditMode.SetActiveLayout
---
