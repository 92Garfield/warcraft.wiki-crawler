...
function C_ProfSpecs.CanRefundPath(pathID, configID)
end
...
function C_ProfSpecs.CanUnlockTab(tabTreeID, configID)
end

---
---@param pathID number 
---@return number childIDs []
function C_ProfSpecs.GetChildrenForPath(pathID)
end
...
function C_ProfSpecs.GetDescriptionForPath(pathID)
end

---
---@param perkID number 
---@return string description 
function C_ProfSpecs.GetDescriptionForPerk(perkID)
end

---
---@param perkID number 
---@return number entryID 
function C_ProfSpecs.GetEntryIDForPerk(perkID)
end
...
function C_ProfSpecs.GetPerksForPath(pathID)
end

---
---@param tabTreeID number 
---@return number rootPathID ?
function C_ProfSpecs.GetRootPathForTab(tabTreeID)
end
...
function C_ProfSpecs.GetSourceTextForPath(pathID, configID)
end
...
function C_ProfSpecs.GetSpendCurrencyForPath(pathID)
end

---
---@param pathID number 
---@return number entryID 
function C_ProfSpecs.GetSpendEntryForPath(pathID)
end
...
function C_ProfSpecs.GetStateForPath(pathID, configID)
end
...
function C_ProfSpecs.GetStateForPerk(perkID, configID)
end
...
function C_ProfSpecs.GetStateForTab(tabTreeID, configID)
end

---
---@param tabTreeID number 
---@return ProfTabInfo tabInfo ?
function C_ProfSpecs.GetTabInfo(tabTreeID)
end

---
---@param pathID number 
---@return number entryID 
function C_ProfSpecs.GetUnlockEntryForPath(pathID)
end

---
---@param perkID number 
---@return number unlockRank ?
function C_ProfSpecs.GetUnlockRankForPerk(perkID)
end
...
---@param skillLineID number 
---@return boolean showReminder 
function C_ProfSpecs.ShouldShowPointsReminderForSkillLine(skillLineID)
end
